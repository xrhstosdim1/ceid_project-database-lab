...
public class has_degree extends javax.swing.JFrame {
Connection conn=null;
ResultSet rs =null;
PreparedStatement pst=null;
    /**
     * Creates new form has_degree
     */
    public has_degree() {
        initComponents();
    ...
    private void Update_Table(){
        try {
                  String sql = "SELECT * FROM has_degree" ;
    ...
    private void initComponents() {
        ...
        txt_degr_title = new javax.swing.JTextField();
        txt_degr_idryma = new javax.swing.JTextField();
        txt_cand_username = new javax.swing.JTextField();
        txt_etos = new javax.swing.JTextField();
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "has_degree", "applicationshistory", "applies", "dbas", "degree", "employee", "etairia", "evaluator", "job", "languages", "Log_Files", "project", "requires", "subject", "user" }));
        ...
        jLabel2.setText("degr_title");

        jLabel3.setText("degr_idryma");

        jLabel4.setText("cand_username");

        jLabel5.setText("etos");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_cand_username)
                            .addComponent(txt_degr_idryma)
                            .addComponent(txt_degr_title)
                            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(39, 39, 39)
                                .addComponent(jLabel2))
                            .addComponent(txt_degr_title, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel4))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(txt_degr_idryma, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jLabel5))
                    .addComponent(txt_etos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel6)
...
public void close() { 
    ...
    private void Table_showMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table_showMouseClicked
        try{
            ...
            String sql = "select * from has_degree where degr_title='"+Table_click+"' AND degr_idryma = '"+Table_click+"' AND cand_username = '"+Table_click+"' ";
            pst= conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next()){
                String add1 =rs.getString("degr_title");
                txt_degr_title.setText(add1);
                String add2 =rs.getString("degr_idryma");
                txt_degr_idryma.setText(add2);
                String add3 =rs.getString("cand_username");
                txt_cand_username.setText(add3);
                String add4 =rs.getString("etos");
                txt_etos.setText(add4);
    ...
    private void insert_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insert_btnActionPerformed
       try{
            String sql ="INSERT INTO has_degree (degr_title, degr_idryma, cand_username, etos, grade) VALUES (?, ?, ?, ?, ?)";
            pst=conn.prepareStatement(sql);
            pst.setString(1, txt_degr_title.getText());
            pst.setString(2, txt_degr_idryma.getText());
            pst.setString(3, txt_cand_username.getText());
            pst.setString(4, txt_etos.getText());
    ...
    private void update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_btnActionPerformed
       try{
            String value1= txt_degr_title.getText();
            String value2= txt_degr_idryma.getText();
            String value3= txt_cand_username.getText();
            String value4= txt_etos.getText();
            String value5= txt_grade.getText();
           
            String sql ="UPDATE  has_degree set degr_title='"+value1+"', degr_idryma='"+value2+"', cand_username='"+value3+"',etos='"+value4+"', grade = '"+value5+"'  WHERE degr_title='"+value1+"' AND degr_idryma='"+value2+"' AND cand_username='"+value3+"'";
            pst=conn.prepareStatement(sql);
            pst.execute();
    ...
    private void delete_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_btnActionPerformed
       try{
            String sql ="DELETE FROM has_degree WHERE degr_title = ?  AND degr_idryma = ? AND cand_username = ?";
            pst=conn.prepareStatement(sql);
            pst.setString(1, txt_degr_title.getText());
            pst.setString(2, txt_degr_idryma.getText());
            pst.setString(3, txt_cand_username.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(has_degree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new has_degree().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txt_degr_idryma;
    private javax.swing.JTextField txt_degr_title;
    private javax.swing.JTextField txt_etos;
