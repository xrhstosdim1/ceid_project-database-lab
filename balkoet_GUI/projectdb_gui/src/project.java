...
private void Update_Table(){
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "project", "applicationshistory", "applies", "dbas", "degree", "employee", "etairia", "evaluator", "has_degree", "job", "languages", "Log_Files", "requires", "subject", "user" }));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(log_out_btn, javax.swing.GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE)
...
public void close() { 
    ...
    private void Table_showMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table_showMouseClicked
        try{
            ...
            String sql = "select * from project where cand_id='"+Table_click+"' AND num='"+Table_click+"' ";
            pst= conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next()){
    ...
    private void insert_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insert_btnActionPerformed
        try{
            String sql ="INSERT INTO project (cand_id, num, description, url) VALUES (?, ?, ?, ?)";
            pst=conn.prepareStatement(sql);
            pst.setString(1, txt_cand_id.getText());
            pst.setString(2, txt_num.getText());
    ...
    private void update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_btnActionPerformed
      try{
            ...
            String value2= txt_num.getText();
            String value3= txt_description.getText();
            String value4= txt_url.getText();
           
            String sql ="UPDATE  project set cand_id='"+value1+"', num='"+value2+"', description='"+value3+"', url='"+value4+"' WHERE cand_id='"+value1+"' AND num='"+value2+"'";
            pst=conn.prepareStatement(sql);
            pst.execute();
    ...
    private void delete_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_btnActionPerformed
        try{
            String sql ="DELETE FROM project WHERE cand_id = ? AND num = ? ";
            pst=conn.prepareStatement(sql);
            pst.setString(1, txt_cand_id.getText());
            pst.setString(2, txt_num.getText());
            pst.execute();
